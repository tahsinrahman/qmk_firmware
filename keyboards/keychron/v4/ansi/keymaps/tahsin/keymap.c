...
const key_override_t ctrl_h_override = ko_make_with_layers_and_negmods(MOD_BIT(KC_LCTL), KC_H, KC_LEFT, ~0, MOD_BIT(KC_RCTL));
const key_override_t ctrl_j_override = ko_make_with_layers_and_negmods(MOD_BIT(KC_LCTL), KC_J, KC_DOWN, ~0, MOD_BIT(KC_RCTL));
const key_override_t ctrl_k_override = ko_make_with_layers_and_negmods(MOD_BIT(KC_LCTL), KC_K, KC_UP, ~0, MOD_BIT(KC_RCTL));
const key_override_t ctrl_l_override = ko_make_with_layers_and_negmods(MOD_BIT(KC_LCTL), KC_L, KC_RIGHT, ~0, MOD_BIT(KC_RCTL));
